...
NOTE_AS4,32,NOTE_C5,32,NOTE_D5,3,NOTE_AS5,8,NOTE_C5,8,NOTE_G4,8,NOTE_G5,8,NOTE_F5,3,REST,8,NOTE_C5,4,NOTE_G4,8,NOTE_G5,8,NOTE_F5,4,NOTE_AS4,6,NOTE_D5,6,NOTE_F5,6,NOTE_F5,16,NOTE_AS5,8,
NOTE_F5,14,NOTE_DS5,14,NOTE_D5,12,NOTE_DS5,12,NOTE_AS5,12,NOTE_D6,12,NOTE_DS6,8,NOTE_AS6,12,NOTE_DS6,8,NOTE_AS6,12,NOTE_DS6,8,NOTE_AS6,-2,REST,4,REST,12,
...
NOTE_G5,6,NOTE_F5,6,NOTE_F5,5,NOTE_E5,8,NOTE_E5,8,NOTE_F5,8,NOTE_C5,2,REST,6,REST,32,
NOTE_C5,16,REST,16,NOTE_F5,6,NOTE_E5,6,NOTE_F5,-5,NOTE_A4,8,NOTE_F5,8,NOTE_E5,6,NOTE_F5,6,NOTE_C5,-5,NOTE_C5,8,NOTE_C5,16,REST,16,
NOTE_G5,6,NOTE_F5,6,NOTE_F5,-5,NOTE_E5,16,REST,16,NOTE_F5,8,NOTE_G5,6,NOTE_A5,6,NOTE_D5,3,REST,32,
NOTE_D5,16,NOTE_C5,16,NOTE_D5,6,NOTE_F4,6,NOTE_D4,8,NOTE_D5,9,NOTE_AS4,9,NOTE_D5,9,NOTE_F5,9,NOTE_E5,6,NOTE_F5,6,NOTE_E5,3,REST,8,
...
NOTE_C5,8,NOTE_C6,8,NOTE_AS5,8,NOTE_A5,8,NOTE_G5,8,NOTE_G5,8,NOTE_A5,4,NOTE_AS5,8,NOTE_A5,8,NOTE_F5,3,REST,4,REST,16,NOTE_D5,6,NOTE_E5,6,NOTE_F5,8,NOTE_C6,3,NOTE_AS5,4,NOTE_A5,4,NOTE_A5,-2,REST,8,
NOTE_G5,8,NOTE_G5,16,NOTE_GS5,16,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_C6,8,NOTE_DS5,8,NOTE_D5,4,
NOTE_D5,8,NOTE_DS5,8,NOTE_F5,4,NOTE_G5,8,NOTE_GS5,8,NOTE_C6,8,NOTE_D6,4,NOTE_DS6,8,NOTE_D6,4,NOTE_AS5,8,REST,8,
NOTE_F5,4,NOTE_G5,8,NOTE_DS5,4,REST,3,NOTE_C4,16,NOTE_D4,16,NOTE_DS4,8,REST,4,
NOTE_DS4,8,NOTE_DS4,8,NOTE_C4,8,NOTE_DS4,8,NOTE_F4,8,NOTE_AS4,4,NOTE_GS4,8,NOTE_G4,4,NOTE_F4,8,NOTE_G4,8,NOTE_GS4,8,NOTE_G4,4,REST,8,
NOTE_F5,16,NOTE_G5,16,NOTE_G5,8,NOTE_F5,8,NOTE_C6,16,REST,16,NOTE_C6,4,NOTE_A5,8,NOTE_C6,8,NOTE_B5,3,REST,8,
NOTE_G5,16,NOTE_GS5,16,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_C6,16,REST,16,NOTE_DS5,8,NOTE_D5,8,REST,8,
NOTE_D5,8,NOTE_DS5,8,NOTE_F5,4,NOTE_G5,8,NOTE_DS6,8,NOTE_D6,4,NOTE_D6,8,NOTE_DS6,16,REST,16,NOTE_D6,4,NOTE_C6,4,NOTE_G5,3,NOTE_GS5,8,NOTE_G5,4,REST,4,
NOTE_F4,16,NOTE_G4,16,NOTE_DS4,8,REST,4,NOTE_DS4,4,NOTE_C4,8,NOTE_D4,8,NOTE_DS4,8,NOTE_F4,6,NOTE_G4,6,NOTE_D4,8,REST,8,
NOTE_D5,8,NOTE_DS5,8,NOTE_F5,16,REST,16,NOTE_AS5,5,NOTE_GS5,5,NOTE_G5,4,NOTE_F5,8,NOTE_G5,8,NOTE_DS5,8,NOTE_F5,2,REST,8,NOTE_D5,8,NOTE_DS5,8,NOTE_F5,16,REST,16,NOTE_F5,6,NOTE_F5,6,NOTE_E5,-1,REST,8,
NOTE_G5,3,NOTE_AS4,16,NOTE_AS4,16,NOTE_AS4,4,NOTE_DS5,8,NOTE_G5,12,NOTE_AS4,32,NOTE_F5,-5,NOTE_F4,8,NOTE_AS4,8,NOTE_DS5,2,NOTE_AS5,-2,NOTE_F5,4,
...
REST,8,NOTE_D5,6,NOTE_E5,6,NOTE_F5,16,REST,16,NOTE_C6,3,REST,16,NOTE_AS5,6,REST,16,NOTE_A5,8,REST,8,NOTE_A5,-2,REST,6, // 6 -> REST,8,??
NOTE_G5,16,NOTE_GS5,16,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_C6,8,NOTE_DS5,8,NOTE_D5,4,NOTE_D5,8,NOTE_DS5,8,NOTE_F5,4,NOTE_G5,8,NOTE_GS5,8,NOTE_C6,8,NOTE_D6,4,NOTE_DS6,8,NOTE_D6,4,NOTE_AS5,8,REST,8,
NOTE_F5,4,NOTE_G5,8,NOTE_DS5,2,REST,8,NOTE_C4,16,NOTE_D4,16,NOTE_DS4,8,REST,4,
NOTE_DS4,8,NOTE_DS4,8,NOTE_C4,8,NOTE_DS4,8,NOTE_F4,8,NOTE_AS4,4,NOTE_GS4,8,NOTE_G4,4,NOTE_F4,8,NOTE_G4,8,NOTE_GS4,8,NOTE_G4,4,REST,8,
NOTE_F5,16,NOTE_G5,16,NOTE_G5,8,NOTE_F5,8,NOTE_C6,16,REST,16,NOTE_C6,4,NOTE_A5,8,NOTE_C6,8,NOTE_B5,3,REST,8,
NOTE_G5,16,NOTE_GS5,16,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_AS5,8,NOTE_C6,8,NOTE_DS5,8,NOTE_D5,8,REST,8,NOTE_D5,8,NOTE_DS5,8,NOTE_F5,4,NOTE_G5,8,NOTE_DS6,8,NOTE_D6,4,NOTE_D6,8,NOTE_DS6,8,NOTE_D6,4,NOTE_C6,4,NOTE_G5,4,NOTE_G5,8,NOTE_GS5,8,NOTE_G5,3,REST,6,
NOTE_F4,16,NOTE_G4,16,NOTE_DS4,8,REST,4,NOTE_DS4,4,NOTE_C4,8,NOTE_D4,8,NOTE_DS4,8,NOTE_F4,6,NOTE_G4,6,NOTE_D4,8,REST,8,
NOTE_D5,8,NOTE_DS5,8,NOTE_F5,16,REST,16,NOTE_AS5,6,NOTE_GS5,6,NOTE_G5,4,NOTE_F5,8,NOTE_G5,8,NOTE_DS5,8,NOTE_F5,2,REST,8,
...
NOTE_DS5,4,NOTE_D5,8,NOTE_DS5,8,NOTE_AS5,8,NOTE_GS5,8,NOTE_G5,8,NOTE_DS5,8,NOTE_G5,16,NOTE_GS5,16,NOTE_AS5,3,NOTE_GS5,16,NOTE_G5,16,NOTE_GS5,16,NOTE_G5,16,NOTE_DS5,16,NOTE_F5,16,NOTE_AS4,16,NOTE_C5,16,NOTE_DS5,3,NOTE_GS5,16,NOTE_G5,16,NOTE_F5,3,
NOTE_DS5,16,NOTE_D5,16,NOTE_DS5,16,NOTE_D5,16,NOTE_AS4,4,NOTE_F5,8,NOTE_G5,6,NOTE_D5,6,NOTE_AS4,6,NOTE_F5,6,NOTE_D5,8,NOTE_AS5,8,NOTE_G5,4,REST,16,NOTE_G5,16,
NOTE_AS5,16,NOTE_AS5,16,NOTE_AS5,6,NOTE_AS5,6,NOTE_AS5,8,NOTE_AS5,6,NOTE_GS5,6,NOTE_G5,8,NOTE_F5,6,NOTE_G5,6,NOTE_GS5,8,NOTE_G5,6,NOTE_DS5,6,NOTE_F5,16,NOTE_DS5,16,NOTE_AS4,4,REST,16,
...
NOTE_G6,16,NOTE_GS6,16,NOTE_AS6,8,NOTE_AS6,8,NOTE_AS6,8,NOTE_AS6,8,NOTE_AS6,8,NOTE_C7,8,NOTE_DS6,8,NOTE_D6,4,NOTE_D6,8,NOTE_DS6,8,NOTE_F6,4,NOTE_G6,8,NOTE_GS6,8,NOTE_C7,8,NOTE_D7,4,NOTE_DS7,8,NOTE_D7,4,NOTE_AS6,8,REST,8,
NOTE_F6,4,NOTE_G6,8,NOTE_DS6,4,REST,8,REST,4,
NOTE_C5,16,NOTE_D5,16,NOTE_DS5,4,REST,8,NOTE_DS5,8,NOTE_DS5,8,NOTE_C5,8,NOTE_DS5,8,NOTE_F5,8,NOTE_AS5,4,NOTE_GS5,8,NOTE_G5,4,NOTE_F5,8,NOTE_G5,8,NOTE_GS5,8,NOTE_G5,8,REST,4,
NOTE_G5,16,NOTE_G5,16,NOTE_G5,8,NOTE_F5,8,NOTE_C6,16,REST,16,NOTE_C6,4,NOTE_D6,8,NOTE_DS6,8,NOTE_D6,4,REST,4,
